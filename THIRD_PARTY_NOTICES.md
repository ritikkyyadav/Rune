...
Gear is a proprietary product. This file records every piece of externally sourced
code or design so the product stays legally clean. Rules (from
`docs/history/Berne-Prescription-Plan.md` §0.5):
...
| What                                                                                              | Origin                                                                                                      | Where in Gear                                     | Notes                                                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
