...
Berne is a proprietary product. This file records every piece of externally sourced
code or design so the product stays legally clean. Rules (from
`Berne-Prescription-Plan.md` §0.5):
...
- Apache-2.0 ports must preserve NOTICE content; MIT ports must preserve the
  copyright line.
- Format/protocol *compatibility* implemented from public documentation or observed
