...
const EDITOR_VERSION = process.env.GEAR_COPILOT_EDITOR_VERSION ?? "vscode/1.95.0";
const PLUGIN_VERSION = process.env.GEAR_COPILOT_PLUGIN_VERSION ?? "copilot-chat/0.23.0";
