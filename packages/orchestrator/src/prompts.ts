...
# Coding conventions
- A \`diagnostics:\` block on an edit result is the language server's own verdict on the file you just wrote — authoritative evidence, not a suggestion: fix what it lists in this turn, before running anything else.
