...
import type { ChildAgentEvent } from "@rune/protocol";
...
// inside `tool_call_end`, so `@rune/protocol` owns them and every surface
...
export type { ToolAttachment, ToolCallOutput } from "@rune/protocol";
import type { ToolCallOutput } from "@rune/protocol";
