...
import {
  ...
  checkBadge,
  type StreamState,
} from "../../../apps/web/src/lib/stream";
import {
  INITIAL_TRACE,
  traceReducer,
  spanDepth,
  type TraceState,
} from "../../../apps/web/src/lib/trace";
import { demoSteps, DEMO_TASK } from "../../../apps/web/src/lib/demo";
import { gearInfo, nextGear, normalizeGear } from "../../../apps/web/src/lib/gears";
