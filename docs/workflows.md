...
```json
{
  ...
  "nodes": [
    ...
    { "id": "security", "kind": "task", "dependsOn": ["scope"], "tier": "heavy",
      "prompt": "Review for SECURITY only. Cite file:line.\n\n{{scope}}" },
    { "id": "report", "kind": "task", "dependsOn": ["security"], "retry": 2,
...
asked. A node whose dependency merely *does not exist in its prompt* is different: its output is
