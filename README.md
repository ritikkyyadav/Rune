...
| <!-- P12.1 --> _run economics on free tiers: lane P12.1 fills this in_                                                   | <!-- P12.2 --> _MCP against real servers: lane P12.2 fills this in_ <br> <!-- P12.3 --> _skills, plugins and hooks: lane P12.3 fills this in_                         | **Research mode's answer quality**, and **workflows** — both run, neither has been scored _(experimental)_                                                                                                |
